...
type CreateMasterEditionArgs struct {
	MaxSupply *uint64 `bin:"optional" json:"max_supply,omitempty"`
}
...
func (obj MintNewEditionFromMasterEditionViaTokenArgs) MarshalWithEncoder(encoder *binary.Encoder) (err error) {
	...
	if err != nil {
		return newFieldError("Edition", err)
	}
	return nil
}
...
type CreateMetadataAccountArgsV3 struct {
	...
	CollectionDetails *CollectionDetails `bin:"optional" json:"collection_details,omitempty"`
}
...
func (obj CreateMetadataAccountArgsV3) MarshalWithEncoder(encoder *binary.Encoder) (err error) {
	...
	if err != nil {
		return newFieldError("IsMutable", err)
	}
	// Serialize `CollectionDetails` (optional):
	{
		if obj.CollectionDetails == nil {
			err = encoder.WriteOption(false)
			if err != nil {
				return newOptionError("CollectionDetails", fmt.Errorf("error while encoding optionality: %w", err))
			}
		} else {
			err = encoder.WriteOption(true)
			if err != nil {
			...
			if err != nil {
				return newFieldError("CollectionDetails", err)
			}
		}
	}
	return nil
...
func (obj *CreateMetadataAccountArgsV3) UnmarshalWithDecoder(decoder *binary.Decoder) (err error) {
	...
	// Deserialize `CollectionDetails` (optional):
	{
		ok, err := decoder.ReadOption()
		if err != nil {
			return newOptionError("CollectionDetails", fmt.Errorf("error while reading optionality: %w", err))
		}
		if ok {
...
type UpdateMetadataAccountArgsV2 struct {
	Data                *DataV2             `bin:"optional" json:"data,omitempty"`
	UpdateAuthority     *solanago.PublicKey `bin:"optional" json:"update_authority,omitempty"`
	PrimarySaleHappened *bool               `bin:"optional" json:"primary_sale_happened,omitempty"`
	IsMutable           *bool               `bin:"optional" json:"is_mutable,omitempty"`
}
...
func (obj UpdateMetadataAccountArgsV2) MarshalWithEncoder(encoder *binary.Encoder) (err error) {
	...
	// Serialize `UpdateAuthority` (optional):
	{
		if obj.UpdateAuthority == nil {
			err = encoder.WriteOption(false)
			if err != nil {
				return newOptionError("UpdateAuthority", fmt.Errorf("error while encoding optionality: %w", err))
			}
		} else {
			err = encoder.WriteOption(true)
			if err != nil {
	...
	// Serialize `PrimarySaleHappened` (optional):
	{
		if obj.PrimarySaleHappened == nil {
			err = encoder.WriteOption(false)
			if err != nil {
				return newOptionError("PrimarySaleHappened", fmt.Errorf("error while encoding optionality: %w", err))
			}
		} else {
			err = encoder.WriteOption(true)
			if err != nil {
			...
			if err != nil {
				return newFieldError("PrimarySaleHappened", err)
			}
		}
	}
	// Serialize `IsMutable` (optional):
	{
		if obj.IsMutable == nil {
			err = encoder.WriteOption(false)
			if err != nil {
				return newOptionError("IsMutable", fmt.Errorf("error while encoding optionality: %w", err))
			}
		} else {
			err = encoder.WriteOption(true)
			if err != nil {
...
func (obj *UpdateMetadataAccountArgsV2) UnmarshalWithDecoder(decoder *binary.Decoder) (err error) {
	...
	// Deserialize `UpdateAuthority` (optional):
	{
		ok, err := decoder.ReadOption()
		if err != nil {
			return newOptionError("UpdateAuthority", fmt.Errorf("error while reading optionality: %w", err))
		}
		if ok {
	...
	// Deserialize `PrimarySaleHappened` (optional):
	{
		ok, err := decoder.ReadOption()
		if err != nil {
			return newOptionError("PrimarySaleHappened", fmt.Errorf("error while reading optionality: %w", err))
		}
		if ok {
	...
	// Deserialize `IsMutable` (optional):
	{
		ok, err := decoder.ReadOption()
		if err != nil {
			return newOptionError("IsMutable", fmt.Errorf("error while reading optionality: %w", err))
		}
		if ok {
			err = decoder.Decode(&obj.IsMutable)
			if err != nil {
...
func (obj ApproveUseAuthorityArgs) MarshalWithEncoder(encoder *binary.Encoder) (err error) {
	...
	if err != nil {
		return newFieldError("NumberOfUses", err)
	}
	return nil
}
...
func (obj AuthorizationData) MarshalWithEncoder(encoder *binary.Encoder) (err error) {
	...
	if err != nil {
		return newFieldError("Payload", err)
	}
	return nil
}
...
type AssetData struct {
	...
	Creators             *[]Creator          `bin:"optional" json:"creators,omitempty"`
	PrimarySaleHappened  bool                `json:"primary_sale_happened"`
	IsMutable            bool                `json:"is_mutable"`
	TokenStandard        TokenStandard       `json:"token_standard"`
	Collection           *Collection         `bin:"optional" json:"collection,omitempty"`
	Uses                 *Uses               `bin:"optional" json:"uses,omitempty"`
	CollectionDetails    *CollectionDetails  `bin:"optional" json:"collection_details,omitempty"`
	RuleSet              *solanago.PublicKey `bin:"optional" json:"rule_set,omitempty"`
}
...
func (obj AssetData) MarshalWithEncoder(encoder *binary.Encoder) (err error) {
	...
	if err != nil {
		return newFieldError("Symbol", err)
	}
	// Serialize `Uri`:
	...
	if err != nil {
		return newFieldError("SellerFeeBasisPoints", err)
	}
	// Serialize `Creators` (optional):
	{
		if obj.Creators == nil {
			err = encoder.WriteOption(false)
			if err != nil {
				return newOptionError("Creators", fmt.Errorf("error while encoding optionality: %w", err))
			}
		} else {
			err = encoder.WriteOption(true)
			if err != nil {
	...
	if err != nil {
		return newFieldError("TokenStandard", err)
	}
	// Serialize `Collection` (optional):
	{
		if obj.Collection == nil {
			err = encoder.WriteOption(false)
			if err != nil {
				return newOptionError("Collection", fmt.Errorf("error while encoding optionality: %w", err))
			}
		} else {
			err = encoder.WriteOption(true)
			if err != nil {
			...
			if err != nil {
				return newFieldError("Collection", err)
			}
		}
	}
	// Serialize `Uses` (optional):
	{
		if obj.Uses == nil {
			err = encoder.WriteOption(false)
			if err != nil {
				return newOptionError("Uses", fmt.Errorf("error while encoding optionality: %w", err))
			}
		} else {
			err = encoder.WriteOption(true)
			if err != nil {
	...
	// Serialize `RuleSet` (optional):
	{
		if obj.RuleSet == nil {
			err = encoder.WriteOption(false)
			if err != nil {
				return newOptionError("RuleSet", fmt.Errorf("error while encoding optionality: %w", err))
			}
		} else {
			err = encoder.WriteOption(true)
			if err != nil {
...
func (obj *AssetData) UnmarshalWithDecoder(decoder *binary.Decoder) (err error) {
	...
	// Deserialize `Creators` (optional):
	{
		ok, err := decoder.ReadOption()
		if err != nil {
			return newOptionError("Creators", fmt.Errorf("error while reading optionality: %w", err))
		}
		if ok {
	...
	// Deserialize `Collection` (optional):
	{
		ok, err := decoder.ReadOption()
		if err != nil {
			return newOptionError("Collection", fmt.Errorf("error while reading optionality: %w", err))
		}
		if ok {
	...
	// Deserialize `Uses` (optional):
	{
		ok, err := decoder.ReadOption()
		if err != nil {
			return newOptionError("Uses", fmt.Errorf("error while reading optionality: %w", err))
		}
		if ok {
	...
	// Deserialize `RuleSet` (optional):
	{
		ok, err := decoder.ReadOption()
		if err != nil {
			return newOptionError("RuleSet", fmt.Errorf("error while reading optionality: %w", err))
		}
		if ok {
...
func (obj Creator) MarshalWithEncoder(encoder *binary.Encoder) (err error) {
	...
	if err != nil {
		return newFieldError("Share", err)
	}
	return nil
}
...
type Reservation struct {
	Address        solanago.PublicKey `json:"address"`
	SpotsRemaining uint64             `json:"spots_remaining"`
...
func (obj Reservation) MarshalWithEncoder(encoder *binary.Encoder) (err error) {
	...
	if err != nil {
		return newFieldError("SpotsRemaining", err)
	}
	// Serialize `TotalSpots`:
	err = encoder.Encode(obj.TotalSpots)
	if err != nil {
		return newFieldError("TotalSpots", err)
	}
	return nil
}
...
type ReservationV1 struct {
	Address        solanago.PublicKey `json:"address"`
	SpotsRemaining uint8              `json:"spots_remaining"`
	TotalSpots     uint8              `json:"total_spots"`
}
...
func (obj SeedsVec) MarshalWithEncoder(encoder *binary.Encoder) (err error) {
	...
	if err != nil {
		return newFieldError("Seeds", err)
	}
	return nil
}
...
func (obj ProofInfo) MarshalWithEncoder(encoder *binary.Encoder) (err error) {
	...
	if err != nil {
		return newFieldError("Proof", err)
	}
	return nil
}
...
func (obj Uses) MarshalWithEncoder(encoder *binary.Encoder) (err error) {
	...
	if err != nil {
		return newFieldError("UseMethod", err)
	}
	// Serialize `Remaining`:
	err = encoder.Encode(obj.Remaining)
	if err != nil {
		return newFieldError("Remaining", err)
	}
	// Serialize `Total`:
	err = encoder.Encode(obj.Total)
	if err != nil {
		return newFieldError("Total", err)
	}
	return nil
}
...
func (obj DelegateArgs_CollectionV1) MarshalWithEncoder(encoder *binary.Encoder) (err error) {
	// Serialize `AuthorizationData` (optional):
	{
		if obj.AuthorizationData == nil {
			err = encoder.WriteOption(false)
			if err != nil {
				return newOptionError("AuthorizationData", fmt.Errorf("error while encoding optionality: %w", err))
			}
		} else {
			err = encoder.WriteOption(true)
			if err != nil {
			...
			if err != nil {
				return newFieldError("AuthorizationData", err)
			}
		}
	}
	return nil
...
func (obj *DelegateArgs_CollectionV1) UnmarshalWithDecoder(decoder *binary.Decoder) (err error) {
	// Deserialize `AuthorizationData` (optional):
	{
		ok, err := decoder.ReadOption()
		if err != nil {
			return newOptionError("AuthorizationData", fmt.Errorf("error while reading optionality: %w", err))
		}
		if ok {
...
func (obj DelegateArgs_LockedTransferV1) MarshalWithEncoder(encoder *binary.Encoder) (err error) {
	...
	if err != nil {
		return newFieldError("LockedAddress", err)
	}
	// Serialize `AuthorizationData` (optional):
	{
		if obj.AuthorizationData == nil {
...
func (obj CreateArgs_V1) MarshalWithEncoder(encoder *binary.Encoder) (err error) {
	...
	if err != nil {
		return newFieldError("AssetData", err)
	}
	// Serialize `Decimals` (optional):
	{
		if obj.Decimals == nil {
			err = encoder.WriteOption(false)
			if err != nil {
				return newOptionError("Decimals", fmt.Errorf("error while encoding optionality: %w", err))
			}
		} else {
			err = encoder.WriteOption(true)
			if err != nil {
			...
			if err != nil {
				return newFieldError("Decimals", err)
			}
		}
	}
	// Serialize `PrintSupply` (optional):
	{
		if obj.PrintSupply == nil {
			err = encoder.WriteOption(false)
			if err != nil {
				return newOptionError("PrintSupply", fmt.Errorf("error while encoding optionality: %w", err))
			}
		} else {
			err = encoder.WriteOption(true)
			if err != nil {
			...
			if err != nil {
				return newFieldError("PrintSupply", err)
			}
		}
	}
	return nil
...
func (obj *CreateArgs_V1) UnmarshalWithDecoder(decoder *binary.Decoder) (err error) {
	...
	// Deserialize `Decimals` (optional):
	{
		ok, err := decoder.ReadOption()
		if err != nil {
			return newOptionError("Decimals", fmt.Errorf("error while reading optionality: %w", err))
		}
		if ok {
	...
	// Deserialize `PrintSupply` (optional):
	{
		ok, err := decoder.ReadOption()
		if err != nil {
			return newOptionError("PrintSupply", fmt.Errorf("error while reading optionality: %w", err))
		}
		if ok {
...
func (obj UpdateArgs_V1) MarshalWithEncoder(encoder *binary.Encoder) (err error) {
	...
	{
		err := EncodeCollectionToggle(encoder, obj.Collection)
		if err != nil {
			return newFieldError("Collection", err)
		}
	}
	...
	{
		err := EncodeCollectionDetailsToggle(encoder, obj.CollectionDetails)
		if err != nil {
			return newFieldError("CollectionDetails", err)
		}
	}
	// Serialize `Uses`:
	{
		err := EncodeUsesToggle(encoder, obj.Uses)
		if err != nil {
			return newFieldError("Uses", err)
		}
	}
	// Serialize `RuleSet`:
	{
		err := EncodeRuleSetToggle(encoder, obj.RuleSet)
		if err != nil {
			return newFieldError("RuleSet", err)
		}
	}
...
func (obj UpdateArgs_AsUpdateAuthorityV2) MarshalWithEncoder(encoder *binary.Encoder) (err error) {
	...
	// Serialize `TokenStandard` (optional):
	{
		if obj.TokenStandard == nil {
			err = encoder.WriteOption(false)
			if err != nil {
				return newOptionError("TokenStandard", fmt.Errorf("error while encoding optionality: %w", err))
			}
		} else {
			err = encoder.WriteOption(true)
			if err != nil {
...
func (obj *UpdateArgs_AsUpdateAuthorityV2) UnmarshalWithDecoder(decoder *binary.Decoder) (err error) {
	...
	// Deserialize `TokenStandard` (optional):
	{
		ok, err := decoder.ReadOption()
		if err != nil {
			return newOptionError("TokenStandard", fmt.Errorf("error while reading optionality: %w", err))
		}
		if ok {
			err = decoder.Decode(&obj.TokenStandard)
			if err != nil {
...
func (obj CollectionDetailsToggle_Set) MarshalWithEncoder(encoder *binary.Encoder) (err error) {
	// Serialize `V0`:
	{
		err := EncodeCollectionDetails(encoder, obj.V0)
		if err != nil {
			return newFieldError("V0", err)
		}
	}
...
func (obj CollectionDetails_V2) MarshalWithEncoder(encoder *binary.Encoder) (err error) {
	...
	if err != nil {
		return newFieldError("Padding", err)
	}
	return nil
}
...
type PayloadEntry struct {
	Key   string      `json:"key"`
	Value PayloadType `json:"value"`
}

func (obj PayloadEntry) MarshalWithEncoder(encoder *binary.Encoder) (err error) {
	// Serialize `Key`:
	err = encoder.Encode(obj.Key)
	if err != nil {
		return newFieldError("Key", err)
	...
	// Serialize `Value`:
	{
		err := EncodePayloadType(encoder, obj.Value)
		if err != nil {
...
func (obj PayloadEntry) Marshal() ([]byte, error) {
	buf := bytes.NewBuffer(nil)
	encoder := binary.NewBorshEncoder(buf)
	err := obj.MarshalWithEncoder(encoder)
	if err != nil {
		return nil, fmt.Errorf("error while encoding PayloadEntry: %w", err)
	}
	return buf.Bytes(), nil
}

func (obj *PayloadEntry) UnmarshalWithDecoder(decoder *binary.Decoder) (err error) {
	// Deserialize `Key`:
	err = decoder.Decode(&obj.Key)
	if err != nil {
		return newFieldError("Key", err)
	...
	{
		var err error
		obj.Value, err = DecodePayloadType(decoder)
		if err != nil {
			return err
		}
	}
...
func (obj *PayloadEntry) Unmarshal(buf []byte) error {
	err := obj.UnmarshalWithDecoder(binary.NewBorshDecoder(buf))
	if err != nil {
		return fmt.Errorf("error while unmarshaling PayloadEntry: %w", err)
	}
	return nil
}

func UnmarshalPayloadEntry(buf []byte) (*PayloadEntry, error) {
	obj := new(PayloadEntry)
	err := obj.Unmarshal(buf)
	if err != nil {
		return nil, err
	}
...
func (obj MetadataDelegateRecord) MarshalWithEncoder(encoder *binary.Encoder) (err error) {
	...
	if err != nil {
		return newFieldError("Mint", err)
	}
	// Serialize `Delegate`:
	err = encoder.Encode(obj.Delegate)
	if err != nil {
		return newFieldError("Delegate", err)
	}
...
type Edition struct {
	Key     Key                `json:"key"`
	Parent  solanago.PublicKey `json:"parent"`
	Edition uint64             `json:"edition"`
}
...
func (obj Edition) MarshalWithEncoder(encoder *binary.Encoder) (err error) {
	...
	if err != nil {
		return newFieldError("Parent", err)
	}
	// Serialize `Edition`:
	err = encoder.Encode(obj.Edition)
	if err != nil {
...
func (obj EditionMarker) MarshalWithEncoder(encoder *binary.Encoder) (err error) {
	...
	if err != nil {
		return newFieldError("Ledger", err)
	}
	return nil
}
...
type TokenOwnedEscrow struct {
	Key       Key                `json:"key"`
	BaseToken solanago.PublicKey `json:"base_token"`
	Authority EscrowAuthority    `json:"authority"`
	Bump      uint8              `json:"bump"`
}
...
func (obj TokenOwnedEscrow) MarshalWithEncoder(encoder *binary.Encoder) (err error) {
	...
	if err != nil {
		return newFieldError("BaseToken", err)
	}
	// Serialize `Authority`:
	{
		err := EncodeEscrowAuthority(encoder, obj.Authority)
		if err != nil {
...
func (obj MasterEditionV2) MarshalWithEncoder(encoder *binary.Encoder) (err error) {
	...
	if err != nil {
		return newFieldError("Supply", err)
	}
	// Serialize `MaxSupply` (optional):
	{
		if obj.MaxSupply == nil {
...
type Metadata struct {
	...
	PrimarySaleHappened bool                `json:"primary_sale_happened"`
	IsMutable           bool                `json:"is_mutable"`
	EditionNonce        *uint8              `bin:"optional" json:"edition_nonce,omitempty"`
	TokenStandard       *TokenStandard      `bin:"optional" json:"token_standard,omitempty"`
	Collection          *Collection         `bin:"optional" json:"collection,omitempty"`
	Uses                *Uses               `bin:"optional" json:"uses,omitempty"`
	CollectionDetails   *CollectionDetails  `bin:"optional" json:"collection_details,omitempty"`
	ProgrammableConfig  *ProgrammableConfig `bin:"optional" json:"programmable_config,omitempty"`
}
...
func (obj Metadata) MarshalWithEncoder(encoder *binary.Encoder) (err error) {
	...
	// Serialize `EditionNonce` (optional):
	{
		if obj.EditionNonce == nil {
			err = encoder.WriteOption(false)
			if err != nil {
				return newOptionError("EditionNonce", fmt.Errorf("error while encoding optionality: %w", err))
			}
		} else {
			err = encoder.WriteOption(true)
			if err != nil {
			...
			if err != nil {
				return newFieldError("EditionNonce", err)
			}
		}
	}
	// Serialize `TokenStandard` (optional):
	...
	// Serialize `ProgrammableConfig` (optional):
	{
		if obj.ProgrammableConfig == nil {
			err = encoder.WriteOption(false)
			if err != nil {
				return newOptionError("ProgrammableConfig", fmt.Errorf("error while encoding optionality: %w", err))
			}
		} else {
			err = encoder.WriteOption(true)
			if err != nil {
			...
			if err != nil {
				return newFieldError("ProgrammableConfig", err)
			}
		}
	}
	return nil
...
func (obj *Metadata) UnmarshalWithDecoder(decoder *binary.Decoder) (err error) {
	...
	// Deserialize `EditionNonce` (optional):
	{
		ok, err := decoder.ReadOption()
		if err != nil {
			return newOptionError("EditionNonce", fmt.Errorf("error while reading optionality: %w", err))
		}
		if ok {
	...
	// Deserialize `ProgrammableConfig` (optional):
	{
		ok, err := decoder.ReadOption()
		if err != nil {
			return newOptionError("ProgrammableConfig", fmt.Errorf("error while reading optionality: %w", err))
		}
		if ok {
...
type TokenRecord struct {
	...
	RuleSetRevision *uint64             `bin:"optional" json:"rule_set_revision,omitempty"`
	Delegate        *solanago.PublicKey `bin:"optional" json:"delegate,omitempty"`
	DelegateRole    *TokenDelegateRole  `bin:"optional" json:"delegate_role,omitempty"`
	LockedTransfer  *solanago.PublicKey `bin:"optional" json:"locked_transfer,omitempty"`
}
...
func (obj TokenRecord) MarshalWithEncoder(encoder *binary.Encoder) (err error) {
	...
	if err != nil {
		return newFieldError("State", err)
	}
	// Serialize `RuleSetRevision` (optional):
	{
		if obj.RuleSetRevision == nil {
			err = encoder.WriteOption(false)
			if err != nil {
				return newOptionError("RuleSetRevision", fmt.Errorf("error while encoding optionality: %w", err))
			}
		} else {
			err = encoder.WriteOption(true)
			if err != nil {
			...
			if err != nil {
				return newFieldError("RuleSetRevision", err)
			}
		}
	}
	// Serialize `Delegate` (optional):
	{
		if obj.Delegate == nil {
			err = encoder.WriteOption(false)
			if err != nil {
				return newOptionError("Delegate", fmt.Errorf("error while encoding optionality: %w", err))
			}
		} else {
			err = encoder.WriteOption(true)
			if err != nil {
	...
	// Serialize `DelegateRole` (optional):
	{
		if obj.DelegateRole == nil {
			err = encoder.WriteOption(false)
			if err != nil {
				return newOptionError("DelegateRole", fmt.Errorf("error while encoding optionality: %w", err))
			}
		} else {
			err = encoder.WriteOption(true)
			if err != nil {
			...
			if err != nil {
				return newFieldError("DelegateRole", err)
			}
		}
	}
	// Serialize `LockedTransfer` (optional):
	{
		if obj.LockedTransfer == nil {
			err = encoder.WriteOption(false)
			if err != nil {
				return newOptionError("LockedTransfer", fmt.Errorf("error while encoding optionality: %w", err))
			}
		} else {
			err = encoder.WriteOption(true)
			if err != nil {
			...
			if err != nil {
				return newFieldError("LockedTransfer", err)
			}
		}
	}
	return nil
...
func (obj *TokenRecord) UnmarshalWithDecoder(decoder *binary.Decoder) (err error) {
	...
	// Deserialize `RuleSetRevision` (optional):
	{
		ok, err := decoder.ReadOption()
		if err != nil {
			return newOptionError("RuleSetRevision", fmt.Errorf("error while reading optionality: %w", err))
		}
		if ok {
	...
	// Deserialize `Delegate` (optional):
	{
		ok, err := decoder.ReadOption()
		if err != nil {
			return newOptionError("Delegate", fmt.Errorf("error while reading optionality: %w", err))
		}
		if ok {
			err = decoder.Decode(&obj.Delegate)
			if err != nil {
	...
	// Deserialize `DelegateRole` (optional):
	{
		ok, err := decoder.ReadOption()
		if err != nil {
			return newOptionError("DelegateRole", fmt.Errorf("error while reading optionality: %w", err))
		}
		if ok {
	...
	// Deserialize `LockedTransfer` (optional):
	{
		ok, err := decoder.ReadOption()
		if err != nil {
			return newOptionError("LockedTransfer", fmt.Errorf("error while reading optionality: %w", err))
		}
		if ok {
...
type ReservationListV2 struct {
	...
	SupplySnapshot          *uint64            `bin:"optional" json:"supply_snapshot,omitempty"`
	Reservations            []Reservation      `json:"reservations"`
	TotalReservationSpots   uint64             `json:"total_reservation_spots"`
	CurrentReservationSpots uint64             `json:"current_reservation_spots"`
}
...
func (obj ReservationListV2) MarshalWithEncoder(encoder *binary.Encoder) (err error) {
	...
	if err != nil {
		return newFieldError("MasterEdition", err)
	}
	// Serialize `SupplySnapshot` (optional):
	{
		if obj.SupplySnapshot == nil {
			err = encoder.WriteOption(false)
			if err != nil {
				return newOptionError("SupplySnapshot", fmt.Errorf("error while encoding optionality: %w", err))
			}
		} else {
			err = encoder.WriteOption(true)
			if err != nil {
			...
			if err != nil {
				return newFieldError("SupplySnapshot", err)
			}
		}
	}
...
func (obj *ReservationListV2) UnmarshalWithDecoder(decoder *binary.Decoder) (err error) {
	...
	// Deserialize `SupplySnapshot` (optional):
	{
		ok, err := decoder.ReadOption()
		if err != nil {
			return newOptionError("SupplySnapshot", fmt.Errorf("error while reading optionality: %w", err))
		}
		if ok {
...
type UseAuthorityRecord struct {
	Key         Key    `json:"key"`
	AllowedUses uint64 `json:"allowed_uses"`
	Bump        uint8  `json:"bump"`
}
...
func (obj UseAuthorityRecord) MarshalWithEncoder(encoder *binary.Encoder) (err error) {
	...
	if err != nil {
		return newFieldError("AllowedUses", err)
	}
	// Serialize `Bump`:
	err = encoder.Encode(obj.Bump)
	if err != nil {
